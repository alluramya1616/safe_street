  ...
  return (
    <div className="report-details-page">
      <div className="report-details-container">
        ...
        <section className="section details-section">
          <p><strong>{icons.calendar} Date:</strong> {new Date(report.dateTime).toLocaleString()}</p>
          <p><strong>{icons.severity} Severity:</strong> {
            report.severity ? (
              <Badge text={report.severity} type="severity" />
            ) : (
              <Badge text="Unknown" type="severity" />
            )
          }</p>
          <p><strong>{icons.damage} Type of Damage:</strong>{" "}
            {report.typeOfDamage?.length ? report.typeOfDamage.map((d, i) => (
        ...
        <section className="section status-update-section">
          ...
          {submitting && <p>Marking as resolved...</p>}
          {isResolved && <p className="success-text">This report has been marked as resolved.</p>}
